...
sensors_t found_sensors[] = {
	...
	{0x51, 0, false}, //  8 ✔ RAK12004 MQ2 CO2 gas sensor !! conflict with RAK15000
	{0x50, 0, false}, //  9 ✔ RAK15000 EEPROM !! conflict with RAK12008
	{0x50, 0, false}, // 10 ✔ RAK12008 MG812 CO2 gas sensor !! conflict with RAK15000
	{0x55, 0, false}, // 11 ✔ RAK12009 MQ3 Alcohol gas sensor
	{0x29, 0, false}, // 12 ✔ RAK12014 Laser ToF sensor
	{0x52, 0, false}, // 13 ✔ RAK12002 RTC module !! conflict with RAK15000
	{0x04, 0, false}, // 14 ✔ RAK14003 LED bargraph module
	{0x59, 0, false}, // 15 ✔ RAK12047 VOC sensor !! conflict with RAK13600, RAK13003, RAK5814
	...
	{0x53, 0, false}, // 19 ✔ RAK12019 LTR390 light sensor !! conflict with RAK15000
	{0x28, 0, false}, // 20 ✔ RAK14002 Touch Button module
	{0x41, 0, false}, // 21 ✔ RAK16000 DC current sensor
	{0x68, 0, false}, // 22 ✔ RAK1905 MPU9250 9DOF sensor !! conflict with RAK12025
	{0x61, 0, false}, // 23 ✔ RAK12037 CO2 sensor !! conflict with RAK16001
	{0x3A, 0, false}, // 24 ✔ RAK12003 IR temperature sensor
	{0x68, 0, false}, // 25 ✔ RAK12040 AMG8833 temperature array sensor
	{0x69, 0, false}, // 26 ✔ RAK12034 BMX160 9DOF sensor
	{0x1D, 0, false}, // 27 ✔ RAK12032 ADXL313 accelerometer
	{0x59, 0, false}, // 28 ✔ RAK5814 ACC608 encryption module (limited I2C speed 100000) !! conflict with RAK12047, RAK13600, RAK13003
	{0x57, 0, false}, // 29 RAK12012 MAX30102 heart rate sensor
	{0x54, 0, false}, // 30 RAK12016 Flex sensor
	{0x47, 0, false}, // 31 RAK13004 PWM expander module
	{0x38, 0, false}, // 32 RAK14001 RGB LED module
	{0x5F, 0, false}, // 33 RAK14004 Keypad interface
	{0x61, 0, false}, // 34 RAK16001 ADC sensor !! conflict with RAK12037
	{0x59, 0, false}, // 35 RAK13600 NFC !! conflict with RAK12047, RAK13600, RAK5814
	{0x59, 0, false}, // 36 RAK16002 Coulomb sensor !! conflict with RAK13600, RAK12047, RAK5814
	{0x20, 0, false}, // 37 RAK13003 IO expander module !! conflict with RAK12035
};
