...
// DEPG  DEPG_HP = {250,122,40,20,40,30,40,50,90,40};  //use 2.13" DEPG0213RWS800F41HP as default B/W/R
// DEPG  DEPG_HP = {212,104,30,15,30,25,30,45,80,30};  //  this is for 2.13" DEPG0213BNS800F42HP B/W
DEPG DEPG_HP = {400, 300, 30, 15, 30, 25, 30, 45, 80, 30}; //  this is for 4.2" DEPG0420BNS19AF4 B/W
...
void refresh_rak14000(void)
{
	...
	else
	{
		...
		if (found_sensors[PM_ID].found_sensor)
		{
			snprintf(disp_text, 59, "RAK10702");
		}
		else
		{
...
void co2_rak14000(bool has_pm)
{
	...
	else
	{
		...
		rak14000_text(DEPG_HP.width / 2 + 15, y_graph - 7, (char *)"2500", txt_color, 1);
		...
		// MYLOG("EPD", "CO2 min %.2f max %.2f", fmin, fmax);
